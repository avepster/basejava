...
- Сделать рефакторинг всех реализаций `ru.javawebinar.basejava.storage.Storage`: заменить метод `ru.javawebinar.basejava.model.Resume[] getAll()` на `List<ru.javawebinar.basejava.model.Resume> getAllSorted()`
